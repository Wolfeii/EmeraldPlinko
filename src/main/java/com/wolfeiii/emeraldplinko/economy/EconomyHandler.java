package com.wolfeiii.emeraldplinko.economy;
...
public class EconomyHandler {
    ...
    private EmeraldPlinko instance;

    public boolean setupEconomy(EmeraldPlinko instance) {
    ...
    public EconomyResponse addMoney(UUID player, double amt) {
        ...
        if (ply != null) {
            ...
            ply.spigot().sendMessage(ChatMessageType.ACTION_BAR, components);
